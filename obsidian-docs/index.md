...
*This index is automatically maintained. Last updated: 2026-08-14T15:00:00+02:00*
...
- [[projects/re-ff8/concepts/command-action-pipeline]] — G07 owns pending-to-current-action flow; G08 publishes a TargetPlan; G09 commits Attack 0x01 HP/event offline. ( #ff8 #battle-system #runtime-memory #concept)
...
- [[projects/re-ff8/concepts/targeting-system]] — Encoded masks feed a live G08 TargetPlan; G09 consumes one direct plan offline for Attack 0x01. ( #ff8 #battle-system #runtime-memory #concept)
...
- [[projects/re-ff8/skills/implementing-iso-battle-migration]] — Full in-process x86 migration guide through G08 live TargetPlan closure and G09 Attack 0x01 offline; P1 still locked, G10 next. ( #ff8 #battle-system #reverse-engineering #testing #skill)
...
- [[projects/re-ff8/references/battle-iso-migration-milestones]] — Dependency roadmap with G05–G08 live-closed and G09 Attack 0x01 offline; G10 is next and unimplemented. ( #ff8 #battle-system #reverse-engineering #testing #reference)
...
- [[projects/final-fantasy-viii-reimaginated/references/p0-g09-attack-slice-validation]] — G09 implements Attack 0x01 offline (STR 51, 24-byte event); live promotion and P1 stay locked, G10 next unimplemented. ( #ff8 #battle-system #testing #runtime-memory #reference)
...
- [[projects/final-fantasy-viii-reimaginated/final-fantasy-viii-reimaginated]] — In-process x86 FF8 battle migration with G05–G08 live-closed and G09 Attack 0x01 offline; P1 still locked. ( #ff8 #battle-system #reverse-engineering #project)
