...
Action emission, spawn, text, inventory mutations, and the G14 `0x71` spawn
cadence remain G16. `dat_sha32` was 0 live because the DAT file base was
not resolved; `section_sha32` identifies the loaded script.
