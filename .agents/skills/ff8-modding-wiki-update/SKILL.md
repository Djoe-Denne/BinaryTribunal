...
Ces règles sont spécifiques à `re-ff8` : elles complètent les instructions globales de Codex sans les remplacer. Respecter les règles d'édition natives, les contrôles de sécurité et les autorisations applicables.
