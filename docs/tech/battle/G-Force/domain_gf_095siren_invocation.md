...
Static reconstruction of 095Siren summon invocation chain and progression semantics without requiring manual in-battle invocation.

## High-Level Result

- Entry: `MAG_095_SIREN_SUMMON_SILENT_VOICE` (`0x739da0`)
...
2. `MAG_095_SIREN_SUMMON_SILENT_VOICE` initializes summon context and schedules BDLink sequence task.
