# Ot_EmitPrim_Code24_AVSZ3_FromObj44_Dup2 @ 0x5EF910

- Instr (live): 56
- Palier: high
- GLM A: fence_found=true finish_reason=stop reasoning_tokens=943
- GLM B: fence_found=true finish_reason=stop reasoning_tokens=1478
- GLM C: fence_found=true finish_reason=stop reasoning_tokens=2118
- A==B: non
- Push IDB: oui
- SetType: int __cdecl Ot_EmitPrim_Code24_AVSZ3_FromObj44_Dup2(_DWORD *, int, int, int)
 ...
 * 56 instr, size 0x9f, end 0x5EF9AF. cdecl, 4 args, retn C3. Saves ebx/ebp/esi/edi.
 * E3c clone rel32 of Ot_EmitPrim_Code24_AVSZ3_FromObj44 @ 0x595AA0 (collision réelle).
...
int __cdecl Ot_EmitPrim_Code24_AVSZ3_FromObj44_Dup2(_DWORD *arg_0, int arg_4, int arg_8, int arg_C)
{
    unsigned char *obj; /* edi */
    unsigned char *pkt; /* esi = *[edi+44h] */
    int otz;            /* edx = *[edi+50h] then SAR CL */
    int shift;          /* ecx = [edi+40h]; SAR uses CL */
    void *ot_base;      /* eax = [edi+3Ch] */
    OtNode24 *node;
    ...
    *(_WORD *)(pkt + 0x1C) = *(_WORD *)((unsigned char *)arg_C + 6);
    ...
    otz = *(int *)(obj + 0x50);
    shift = *(int *)(obj + 0x40);
    ot_base = *(void **)(obj + 0x3C);
    otz >>= (unsigned char)shift; /* sar edx, cl */
