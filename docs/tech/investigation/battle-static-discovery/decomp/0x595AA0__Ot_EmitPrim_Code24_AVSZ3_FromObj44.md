# Ot_EmitPrim_Code24_AVSZ3_FromObj44 @ 0x595AA0
...
- A==B: non
- Push IDB: oui
- SetType: int __cdecl Ot_EmitPrim_Code24_AVSZ3_FromObj44(_DWORD *p_obj, int *p_v0, int *p_v1, int *p_v2)
- Notes parent: POLY_FT3 0x20, tag 0x07000000, code OR 0x24000000. WORD 66 depuis vert+6 vers packet +14h/+0Ch/+1Ch. add esp,24h = 9 cdecl. sar OTZ puis lea [base+otz*4]. EAX=OtNode24_PoolAllocLink. Occupancy 1+2 / 0xD0 / 0x1D0 absents. obj+44h = curseur packet.
 ...
 * 56 instr, size 0x9F, end 0x595B3F. cdecl. retn C3.
...
int __cdecl Ot_EmitPrim_Code24_AVSZ3_FromObj44(
    _DWORD *p_obj,
    int *p_v0,
    int *p_v1,
    int *p_v2)
