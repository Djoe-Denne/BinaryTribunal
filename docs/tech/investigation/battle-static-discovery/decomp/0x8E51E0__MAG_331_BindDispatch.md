# MAG_331_BindDispatch @ 0x8E51E0

- Instr (live): 124
- Palier: high
- GLM A: fence_found=true finish_reason=stop reasoning_tokens=49
- GLM B: fence_found=true finish_reason=stop reasoning_tokens=1160
- GLM C: fence_found=true finish_reason=stop reasoning_tokens=168
- A==B: non
- Push IDB: oui
- SetType: int __cdecl MAG_331_BindDispatch(void)
- Notes parent: STREAM16[57] @ 0x1852B7C. WORD [slot+0x4A]>>12, dec, ja unsigned, jpt_8E51FA 8 DWORD live. Cases 1=.00+0x20 BindResource; 2=.00+0x24 sub_4A29A0 store +168h[idx]; 3=3 slots jl signed; 4=DWORD snapshot + WORD 66; 5/6 sub_504270(1); 7 sub_504270(0); 8 ClearFlags; default seqState+9 bit 0x20 skip, movsx [IP+2] sub_B65370. IP+=4 toutes voies, EAX=nouvel IP. Occupancy/0xD0/0x1D0/0x44/K_GF 0x84 absents.
 ...
 * 124 instr, size 0x1E0, end 0x8E53C0. IDA type int(). cdecl, 0 args, retn C3.
 ...
 * jpt_8E51FA @ 0x8E53C0 live: 0->case1, 1->case2, 2->case3, 3->case4,
 *   4+5->cases 5,6, 6->case7, 7->case8. Nibble 0 and >8 -> def_8E51FA.
 ...
 * STREAM16[57] @ 0x1852B7C = 0x8E51E0. Opcode 57, not MAG_330.
...
int __cdecl MAG_331_BindDispatch(void)
{
    unsigned int nibble;
    unsigned char *table;
    unsigned char *obj;
    ...
    case 3: /* loc_8E5281, jpt[2]: three slots +0x168/+0x16C/+0x170, jl signed */
    ...
    case 4: /* loc_8E52B6, jpt[3]: snapshot live camera */
    ...
    case 5: /* loc_8E530D, jpt[4] and jpt[5] */
    case 6:
        sub_504270(1);
        break;

    case 7: /* loc_8E5326, jpt[6] */
        sub_504270(0);
        break;

    default: /* def_8E51FA @ 0x8E533F: nibble 0 or >8 */
