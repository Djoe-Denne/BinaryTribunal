# GF_202Bahamut_SequenceTick @ 0xB19010
 ...
 * 120 instr, size 0x215, end 0xB19225. IDA type unsigned int(). cdecl, 0 args, retn C3. FLAGS 0x5400. FRSIZE 0.
 * push ebx/esi/edi at 0xB19082 (after early BYTE/WORD stores). No sub esp. No arg_0.
 * Labels loc_B1906B / loc_B1907A / loc_B1907D / loc_B1919C / loc_B191AD / loc_B191D4.
...
unsigned int __cdecl GF_202Bahamut_SequenceTick(void)
{
    unsigned int seqCtx;
    unsigned int slot;
    unsigned int render;
