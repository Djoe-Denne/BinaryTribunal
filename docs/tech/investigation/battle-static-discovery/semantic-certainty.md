...
| Classe | Nombre | Règle |
|---|---:|---|
| CERTAIN | 13 (8 doc + 3 triple Grok + 2 GPU 1+P) | name_only_known+A==B+push, wrapper trivial, ou R/1+P=CERTAIN poussé |
...
| SKIP_NODECOMP | 150 | pas de C réconcilié ; y compris graphismes Square sans decomp |
