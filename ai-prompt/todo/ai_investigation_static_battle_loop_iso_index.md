...
**Remaining static work:** none — the static ISO pack is complete (A1–A6, B1–B4 all closed). Remaining residuals are runtime-only; see the live pack `ai_investigation_live_battle_loop_followups_index.md`.
